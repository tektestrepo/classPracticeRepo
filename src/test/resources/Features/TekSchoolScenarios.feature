Feature: Tek School Scenarios
  ...
  Scenario: SDET2019AUG_SDET_Register_Form_Test
    ...
    And User sends query 'select * from public.customer where email='enrique.forsythe@sakilacustomer.org''
    Then User verify account is created with email 'enrique.forsythe@sakilacustomer.org'
